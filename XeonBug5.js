...
const xtime = moment.tz('Asia/Kolkata').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Africa/Johannesburg').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
...
senddocu(buffer)
    ...
    case 'autostatusview':{
            ...
            case 'leave':
                ...
                replygcxeon('Bye Everyone, my owner Tristan kicked me out 😔🥺')
                ...
                for (let i of anu) {
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                showAdAttribution: true,
                                title: 'Broadcast By Tristan',
                                body: `Sent ${i.length} Group`,
                                thumbnailUrl: 'https://ibb.co/FJWd68j',
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}👋\nWant to Buy Premium? Just chat with Tristan wa.me/27634624586 😉`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            break
            case 'runtime':
                let runtimetext = `Bot Have Been Running For ${runtime(process.uptime())}`
                XeonBotInc.sendMessage(m.chat, {
                    text: runtimetext,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'repo':
                XeonBotInc.sendMessage(m.chat, {
                    text: `repo https://github.com/tristan7122/TRISTAN-BOT=BUG
		    wa.me/27634624586`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on WA:wa.me/27634624586`,
                            thumbnailUrl: 'https://ibb.co/FJWd68j',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
"scheduledCallCreationMessage": {
"callType": "2",
"scheduledTimestampMs": `${moment(1000).tz("Africa/Johannesburg").format("DD/MM/YYYY HH:mm:ss")}`,
"title": xeonybug1,
}
}), { userJid: from, quoted : m})
XeonBotInc.relayMessage(xeongc, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
...
break
            ...
            case 'help':
            case 'alive':
                let xeonmenuoh = `╭══ *❍ 𝗧RISTAN-BOT=BUG ❍*
┃❁ *ᴏᴡɴᴇʀ:* ᴛristan ○■□●
┃❁ *ᴜᴘᴛɪᴍᴇ:* ${runtime(process.uptime())}
┃❁ *User:* ${pushname}
╰┈➤ ${xeonytimewisher} 😄  My bro/my sis
⚠️Don't forget to follow me🥺
*TRISTAN* Instagram:Tristany71
_Any help: WA:Message Tristan on WhatsApp. https://wa.me/message/WSXHC2GN47OGI1
╰═════════════════⊷
╭═══❂ 𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 ❂
┃ ❏ *xʀᴇᴀᴄᴛ <ʀᴇᴘʟʏ ᴄʜᴀᴛ>*
┃ ❏ *x <ɴᴜᴍʙᴇʀ|ᴀᴍᴏᴜɴᴛ>*
